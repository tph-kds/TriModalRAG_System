...
class RetrieverQuery(TextRetrieval):
    ...
    def as_retriever(self, 
        ...
        try: 
            logger.log_message("info", "Starting to retrieve final information embeddings...")
            ...
            logger.log_message("info", "Retrieved final information embeddings successfully")
            return results
        
        except Exception as e:
            logger.log_message("warning", f"Error retrieving final information embeddings: {e}")
