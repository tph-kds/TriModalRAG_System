...
class QdrantVectorDBPipeline:
    ...
    def run_qdrant_vector_db_pipeline(self) -> None:
        try:
            ...
            logger.log_message("warning", "Failed to run to upload embeddings pipeline: " + str(e))
    ...
    def records_all_to_qdrant(self):
        try:
            ...
            text_records, image_records, audio_records = prepare_data_qdrant.run_prepare_data_qdrant_pipeline()
