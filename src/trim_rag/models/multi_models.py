...
from langchain_google_genai import ChatGoogleGenerativeAI # gemini-pro || gemini-pro-vision
    ...
    def multi_models(self, 
        ...
        try: 
            ...
            if name == "gpt2":
                ...
                logger.log_message("info", "Initializing ChatGoogleGenerativeAI multimodal model...")
                tokenizer = GoogleGenerativeAIEmbeddings.from_pretrained(self.name_of_model)
    ...
    def assert_multi_models(self) -> None:
        try:
            ...
            if self.name_of_model == None:
                logger.log_message("info", "No model specified. Please specify a model.")
                assert self.name_of_model != None, "No model specified. Please specify a model."
